...
GS_CAN_STATE_ERROR_WARNING = 1  # TEC/REC > 96
GS_CAN_STATE_ERROR_PASSIVE = 2  # TEC/REC > 127
GS_CAN_STATE_BUS_OFF = 3  # TEC > 255
GS_CAN_STATE_STOPPED = 4
GS_CAN_STATE_SLEEPING = 5

# CAN state names for display
GS_CAN_STATE_NAMES = {
